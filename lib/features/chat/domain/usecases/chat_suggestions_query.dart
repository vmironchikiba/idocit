...
class ChatSuggestionsWithQuery implements UseCase<Either<Failure, void>, NoParams> {
  ...
  Future<Either<Failure, void>> call(NoParams params) async {
    ...
    final query = chatBloc.state.query;
    if (query == null) return Left(AuthFailure(message: 'Query is null', type: AuthErrorType.badTokensData));
