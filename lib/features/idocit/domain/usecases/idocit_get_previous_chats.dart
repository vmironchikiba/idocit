...
class IdocGetPreviousChats implements UseCase<Either<Failure, void>, NoParams> {
  final IdocItBloc idocItBloc;
  final IdocGetChats getChats;

  const IdocGetPreviousChats({required this.idocItBloc, required this.getChats});

  @override
  Future<Either<Failure, void>> call(NoParams params) async {
    LoggerService.logDebug('IdocItLazyInitChats -> call()');
    final limit = idocItBloc.state.limit;
    final offset = idocItBloc.state.offset - limit < 0 ? 0 : idocItBloc.state.offset - limit;
