...
class TtsSetVoice implements UseCase<void, TtsVoice> {
  ...
  @override
  Future<void> call(TtsVoice? currentVoice) async {
    LoggerService.logDebug('TtsSetLanguage -> call(${currentVoice?.name})');
    ttsBloc.add(UpdateTtsCurrentVoice(currentVoice: currentVoice));
  }
}
