...
part 'model/knowledge_category.dart';
part 'model/knowledge_data.dart';
part 'model/knowledge_retrieval.dart';
...
part 'model/tool_arguments.dart';
part 'model/tool_call.dart';
part 'model/tool_function_call.dart';
